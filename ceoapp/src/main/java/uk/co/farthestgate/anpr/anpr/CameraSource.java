...
/**
 * Created by MartinStokes on 19/09/2017.
 */
...
public class CameraSource {
    ...
    private float mRequestedFps = 1.0f;
    public static int mRequestedPreviewWidth = 640;
    public static int mRequestedPreviewHeight = 480;
    ...
    public static TakePhoto mainActivity;
    ...
    public static class Builder {
         ...
         */
        public Builder(Context context, TakePhoto activity) {
            if (context == null) {
    ...
    private Camera createCamera() {
        ...
        mRequestedPreviewWidth = parameters.getPreviewSize().width;
        mRequestedPreviewHeight = parameters.getPreviewSize().height;
...
//        parameters.setPreviewFormat(ImageFormat.JPEG);
    ...
    private byte[] createPreviewBuffer() {
        ...
        long sizeInBits = mRequestedPreviewHeight * mRequestedPreviewWidth * bitsPerPixel;
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    if(count % 5 == 0){
                        Log.d("*** TRY FRAME", String.valueOf(count));
                            mainActivity.tryFrame(mPendingFrameBytes, mRotation);
