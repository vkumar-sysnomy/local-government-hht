package com.farthestgate.android.utils.sftp;
...
public class SFTPClient {
    ...
    public String uploadToFTP(ChannelSftp sftpChannel,String source, String target) throws Exception {
        copyInternalToFTP(sftpChannel, source, target);
        LOG.info("Copied files successfully...");
    ...
    public ChannelSftp createSFTPChannel() throws Exception {
        ...
        session.setTimeout(CeoApplication.getFtpConnectionTimeout());
        session.connect();
    ...
    public void releaseConnection(ChannelSftp sftpChannel) throws Exception {
