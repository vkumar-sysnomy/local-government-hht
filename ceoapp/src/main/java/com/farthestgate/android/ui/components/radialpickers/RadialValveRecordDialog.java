 ...
 */
public class RadialValveRecordDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener
{
    ...
    public interface OnTimeSetListener {
        ...
        void onTimeSet(RadialValveRecordDialog dialog, int hourOfDay, int minute);
    }
    ...
    public static RadialValveRecordDialog newInstance(OnTimeSetListener callback,
            int hourOfDay, int minute, boolean is24HourMode) {
        RadialValveRecordDialog ret = new RadialValveRecordDialog();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDoneButton = (TextView) view.findViewById(R.id.save_valves_button);
        if (mDoneText != null) {
        ...
        mDoneButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCallback != null) {
                    mCallback.onTimeSet(RadialValveRecordDialog.this,
