...
package com.farthestgate.android.ui.components.radialpickers;
...
public class RadialTimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener
{
    ...
    public interface OnTimeSetListener {
        void onTimeSet(RadialTimePickerDialog dialog, int hourOfDay, int minute, String serial);
        void onDismissPDDialog();
    }


    public static RadialTimePickerDialog newInstance(OnTimeSetListener callback,
                                                     int hourOfDay, int minute, boolean is24HourMode, String msg, String heading, String serial) {
        Bundle args = new Bundle();
        args.putString(ARG_MESSAGE, msg);
        args.putString(ARG_TITLE, heading);
        RadialTimePickerDialog ret = new RadialTimePickerDialog();
        ret.initialize(callback, hourOfDay, minute, is24HourMode, serial);
    ...
    public void initialize(OnTimeSetListener callback,
                           int hourOfDay, int minute, boolean is24HourMode, String serial) {
        mCallback = callback;
        serialNo = serial;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtPDSerial      = (EditText) view.findViewById(R.id.txtPDSerial);
        mMinuteSpaceView = (TextView) view.findViewById(R.id.minutes_space);
        mMinuteView      = (TextView) view.findViewById(R.id.minutes);
        mAmPmTextView    = (TextView) view.findViewById(R.id.ampm_label);

        TextView txtHeader = (TextView) view.findViewById(R.id.txtTitle);
        ...
        txtPDSerial.setHint(message);
        txtPDSerial.setText(serialNo);
            ...
            public void onClick(View v) {
                ...
                if (mCallback != null) {
                    mCallback.onTimeSet(RadialTimePickerDialog.this,
                            mTimePicker.getHours(), mTimePicker.getMinutes(), txtPDSerial.getText().toString());
                }
                dismiss();
            }
        });
        ...
        mNoPDButton = (TextView) view.findViewById(R.id.btnCancelPD);
        mNoPDButton.setText("Cancel");
        mNoPDButton.setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
