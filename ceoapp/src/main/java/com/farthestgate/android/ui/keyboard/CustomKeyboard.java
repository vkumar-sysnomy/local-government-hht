...
public class CustomKeyboard extends Keyboard 
{
    ...
    {
        Key key = new LetterKey(res, parent, x, y, parser);
    ...
    static class LetterKey extends Key
    {
        
        public LetterKey(Resources res, Row parent, int x, int y, XmlResourceParser parser)
        {
