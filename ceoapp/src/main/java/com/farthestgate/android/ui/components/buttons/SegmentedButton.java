 ...
 * <p/>
 * Modified - Hanson Aboagye April 2014
 */
public class SegmentedButton extends LinearLayout
{
    ...
    public SegmentedButton(Context context, AttributeSet attrs) {
        ...
        mColorStroke = a.getColor(R.styleable.SegmentedButton_strokeLineColor, 0xFF0000);
        ...
        mStrokeWidth = a.getDimensionPixelSize(R.styleable.SegmentedButton_strokeLineWidth, 1);
    ...
    private void _addButtons(String[] titles) {
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            // make the other buttons user a dark text
            if (i > 0)
                button.setTextColor(getResources().getColor(R.color.ceo_app_light_red));
    ...
    private void handleStateChange(int btnLastIndex, int btnNextIndex) {
        ...
        btnLast.setTextColor(getResources().getColor(R.color.ceo_app_dark_red));
